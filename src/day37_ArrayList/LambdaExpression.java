...
public class LambdaExpression {
    public static void main(String[] args) {
        ...
        numbers.removeIf(oddNumbers); //remove odd
        // numbers.removeIf(p -> p%2 == 0); //remove even
        System.out.println(numbers);

        System.out.println("-----------------");

        ArrayList<String> names = new ArrayList<>();
        names.addAll(Arrays.asList("ali", "veli", "deli", "ahmet"));
        System.out.println(names);
        names.removeIf(each -> each.startsWith("a"));
        System.out.println(names);
